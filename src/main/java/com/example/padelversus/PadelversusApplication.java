...
public class PadelversusApplication implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        File imageFile_1 = DEMO_FILES_FOLDER.resolve("Player_1").toFile();
        ...
        File imageFile_2 = DEMO_FILES_FOLDER.resolve("Player_2").toFile();
        ...
        File imageFile_3 = DEMO_FILES_FOLDER.resolve("Player_3").toFile();
        ...
        File imageFile_4 = DEMO_FILES_FOLDER.resolve("Player_4").toFile();
        ...
        File imageFile_5 = DEMO_FILES_FOLDER.resolve("Player_5").toFile();
        ...
        File imageFile_6 = DEMO_FILES_FOLDER.resolve("Player_6").toFile();
        ...
        File imageFile_7 = DEMO_FILES_FOLDER.resolve("Player_7").toFile();
        ...
        File imageFile_8 = DEMO_FILES_FOLDER.resolve("Player_8").toFile();
        ...
        File imageFile_9 = DEMO_FILES_FOLDER.resolve("Player_9").toFile();
        ...
        File imageFile_10 = DEMO_FILES_FOLDER.resolve("Player_10").toFile();
        ...
        File imageFile_11 = DEMO_FILES_FOLDER.resolve("Player_11").toFile();
        ...
        File imageFile_12 = DEMO_FILES_FOLDER.resolve("Player_12").toFile();
        ...
        File imageFile_13 = DEMO_FILES_FOLDER.resolve("Player_13").toFile();
        ...
        File imageFile_14 = DEMO_FILES_FOLDER.resolve("Player_14").toFile();
        ...
        File imageFile_15 = DEMO_FILES_FOLDER.resolve("Player_15").toFile();
        ...
        File imageFile_16 = DEMO_FILES_FOLDER.resolve("Player_16").toFile();
        ...
        File imageFile_17 = DEMO_FILES_FOLDER.resolve("Player_17").toFile();
        ...
        File imageFile_18 = DEMO_FILES_FOLDER.resolve("Player_18").toFile();
        ...
        File imageFile_19 = DEMO_FILES_FOLDER.resolve("Player_19").toFile();
        ...
        File imageFile_20 = DEMO_FILES_FOLDER.resolve("Player_20").toFile();
